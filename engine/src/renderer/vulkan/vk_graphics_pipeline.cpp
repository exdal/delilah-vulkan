...
VkPipelineLayout _vk::_graphics_pipeline::initialize(VulkanCore *core, float min_depth, float max_depth) {
    ...
    vertShaderStageInfo.module = core->vertex_shader;
    vertShaderStageInfo.pName = "main";

    VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
    fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
    fragShaderStageInfo.module = core->fragment_shader;
    ...
    if (vkCreatePipelineLayout(core->device, &pipelineLayoutInfo, nullptr, &layout) != VK_SUCCESS) {
    ...
    if (vkCreateGraphicsPipelines(core->device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &core->graphics_pipeline) != VK_SUCCESS) {
